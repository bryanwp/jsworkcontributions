<div class="footer-holder">
            ...
            <div class="col-md-4 p-0">
                <div class="footer-list-holder">
                    <form class="form-inline">
                        ...
                        <button type="submit" class="btn btn-default btn-submit"><i class="fa fa-chevron-right" aria-hidden="true"></i></button>
                    </form>
                </div>
            </div>
            <div class="col-md-4 p-0">
                ...
                <div class="footer-list-holder">
                    <ul class="approved">
                        ...
                        <li>
                            ...
                            <a href="https://www.resellerratings.com" onclick="window.open('https://seals.resellerratings.com/landing.php?seller=100333','name','height=760,width=780,scrollbars=1'); return false;"><img style='border:none;' src='//seals.resellerratings.com/seal.php?seller=100333'oncontextmenu="alert('Copying Prohibited by Law - ResellerRatings seal is a Trademark of All Enthusiast, Inc.'); return false;" /></a>
                        </li>
                        <li>
    ...
    <div class="footer-bottom">
        <div class="container p-0">
            ...
            <div class="col-md-4 p-0">
                <div class="sales-toll-holder afterclear">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-10 p-0">
                        <div class="toll-holder">
                            <p>Sales Toll Free:</p>
                            <span>(800) 403 8050</span>
                        </div>
                    </div>
                </div>
                <div class="sales-toll-holder afterclear">
                    ...
                    <div class="col-md-10 p-0">
                        <div class="toll-holder">
                            <p>Customer Service Toll Free:</p>
                            <span>(626) 771 2182</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 p-0">
                <div class="footer-bottom-list">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo get_site_url(); ?>/faqs">FAQs</a>
                        </li>
                        <li>
...
<div class="footer-bottom-copy">
    <div class="container">
        <div class="copyright">
            <p>&copy; Copyright 2016. WristbandCreation.com All Rights Reserved.</p>
        </div>
        <div class="card-list">
            <ul>
                <li>
