...
if (!class_exists('WBC_Front_Scripts')) {
    class WBC_Front_Scripts
    {
        ...
        public function load_scripts() {
            ...
            wp_register_script('material_js', '//cdnjs.cloudflare.com/ajax/libs/bootstrap-material-design/0.2.1/js/material.min.js', array('jquery'), WBC_VERSION, true);
...
//            wp_enqueue_script('evol_colopicker_js');
        ...
        public function load_styles() {
            ...
            wp_register_style('material_style', '//cdnjs.cloudflare.com/ajax/libs/bootstrap-material-design/0.2.1/css/material.min.css', array(), WBC_VERSION);
