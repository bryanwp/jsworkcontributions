                ...
                .on('custom', 'input[name="continues_message"]', function (e, cpos) {
                    ...
                    if ($.browser.chrome) {
                        ...
                        if (input == 0 || input == 1) {
                            ...
                            $('#bandtextpathcont2')[0].setAttribute('startOffset', '2%');
                        ...
                        if ($("#bandtextcontainer")[0].getBoundingClientRect().width > size_[newwidth][$('.wbdiv').width()]['ChromeContMax']) {
                            ...
                            $('#bandtextpathcont2')[0].setAttribute('textLength', '280');
                            $('#bandtextpathcont2')[0].setAttribute('startOffset', '0%');
                            $('#bandtextcont2')[0].setAttribute('text-anchor', 'start');
                            for (var x = 1; x <= 100; x++) {
                                if ($("#bandtextcont1")[0].getBoundingClientRect().width > size_[newwidth][$('.wbdiv').width()]['ChromeContTL']) {
                            ...
                            for (var y = 1; y <= 100; y++) {
                                if ($("#bandtextcont2")[0].getBoundingClientRect().width > size_[newwidth][$('.wbdiv').width()]['ChromeContTL']) {
                                    document.getElementById("bandtextcont2").style.fontSize = (parseInt($("#bandtextcont2").css('font-size')) - 0.1) + 'px';
                                    $("#front-textcont2").text($('#continues_message').val().substring(Math.ceil($("#continues_message").val().length / 2), $("#continues_message").val().length));
                                } else {
                                    break;
                                }
